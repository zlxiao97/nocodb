      ...
      <div class="flex-grow-1 h-100" style="overflow-y: auto">
        ...
        >
          ...
          <template v-else-if="selectedViewId && selectedView">
            ...
            <template v-else-if="selectedView.type === viewTypes.CUSTOM">
              <custom-view :meta="meta" :data="data" />
            </template>
          </template>
        </div>
...
import CustomView from "~/components/project/spreadsheet/views/CustomView";
