    ...
    <v-container fluid class="h-100 py-0">
      <div class="d-flex flex-column h-100">
              ...
              <v-tooltip bottom>
                <template #activator="{ on }">
                  <v-list-item
                    v-if="!isView"
                    dense
                    class="body-2 nc-create-custom-view"
                    v-on="on"
                    @click="openCreateViewDlg(viewTypes.CUSTOM)"
                  >
                    <v-list-item-icon class="mr-n1">
                      <v-icon
                        x-small
                        :color="viewIcons[viewTypes.CUSTOM].color"
                        class="mt-n1"
                      >
                        {{ viewIcons[viewTypes.CUSTOM].icon }}
                      </v-icon>
                    </v-list-item-icon>
                    <v-list-item-title>
                      <span class="font-weight-regular">
        ...
        <div v-if="_isUIAllowed('webhook')" class="mb-2">
          ...
          >
            <v-icon small class="mr-2 nc-btn-webhook"> mdi-hook </v-icon>
            Webhooks
          </v-btn>
        ...
        <div
          v-if="
            !isSharedBase &&
            time - $store.state.settings.miniSponsorCard > 15 * 60 * 1000
          "
        ...
        >
          ...
          >
            ...
            <template #back>
              <span
                class="caption text-left body-1 textColor--text text--lighten-1"
                >{{ supportCost }}</span
              >
              <v-btn
                color="primary"
